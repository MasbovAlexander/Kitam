...
if(isset($_GET[lang])){
    ...
    require_once 'db_connection.php';
     ...
     $result_set = $mysqli->query("SELECT * FROM `requirements` WHERE `id`= $pageID");           //get all from sql db
     $mysqli->close();
...
<body>
    ...
    <main>
        ...
        <?php
        if(isset($_COOKIE["autorize"]) && $_COOKIE["autorize"] == true){       //хтмл редактор для авторизированного пользователя
           echo <<<END
                <form method="post" action='savepage.php?page=requirements&id=$pageID'>
